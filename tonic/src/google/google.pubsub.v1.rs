...
pub struct ValidateMessageRequest {
    ...
    pub schema_spec: ::std::option::Option<validate_message_request::SchemaSpec>,
}
...
pub struct Topic {
    ...
    pub schema_settings: ::std::option::Option<SchemaSettings>,
...
pub struct Subscription {
    ...
    pub topic_message_retention_duration: ::std::option::Option<::prost_types::Duration>,
}
...
pub struct StreamingPullResponse {
    ...
    pub subscription_properties:
        ::std::option::Option<streaming_pull_response::SubscriptionProperties>,
}
